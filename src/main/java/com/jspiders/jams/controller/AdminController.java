...
public class AdminController {
	...
	public ResponseEntity<Optional<FlightInfoDTO>> addFlightInfo(@RequestBody FlightInfoDTO flighInfo,
	...
	public ResponseEntity<FlightInfoDTO> modifyFlightInfo(@RequestBody FlightInfoDTO flighInfo) {
		FlightInfoDTO dto = flightInfoService.modifyFlightInformation(flighInfo);
		if (dto != null) {
	...
	public ResponseEntity<List<FlightInfoDTO>> getFlightInfoByAirlineName(
