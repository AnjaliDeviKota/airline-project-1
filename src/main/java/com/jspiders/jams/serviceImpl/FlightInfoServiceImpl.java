...
public class FlightInfoServiceImpl implements FlightInfoService {
	...
	@Override
	public Optional<FlightInfoDTO> addFlightInformation(FlightInfoDTO flightInfo, int airlineId) {
		...
		return Optional.ofNullable(FlightInfoDTO.builder().flightNumber(flightInfoDB.getFlightNumber())
	...
	@Override
	public FlightInfoDTO modifyFlightInformation(FlightInfoDTO dto) {
		...
		if (findBy.isPresent()) {
			...
			return FlightInfoDTO.builder().flightNumber(updated.getFlightNumber()).flightType(updated.getFlightType())
	...
	public List<FlightInfoDTO> getAllFlightInfo() {
		...
		return flightInfoRepository.findAll().stream()
				.map(t -> FlightInfoDTO.builder().flightNumber(t.getFlightNumber()).flightType(t.getFlightType())
